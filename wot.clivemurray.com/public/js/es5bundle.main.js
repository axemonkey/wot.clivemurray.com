(function () {
  ...
  var things = ['Munchkin', 'Escape the Dark Castle', 'Unearth', 'Star Fluxx', 'Doomlings', 'Dragonwood', 'Dragonrealm', 'Forgotten Island', 'Forgotten Desert ', 'Forgotten Sky', 'Labyrinth', 'Boss Monster', 'Boss Monster: The Next Level', 'Selfish: Zombie Edition', 'Selfish: Space Edition'];
  ...
  var initWot = function initWot() {
    ...
    if (canvas.getContext) {
      ...
      console.log("sectionAngle: ".concat(sectionAngle));
      canvas.width = maxDim;
      ...
      for (var index in randomThings) {
        if (Object.hasOwn(randomThings, index)) {
          ...
          console.log("index: ".concat(index, ", lineX: ").concat(lineX, ", lineY: ").concat(lineY, ", angle: ").concat(angle, ", nextAngle: ").concat(nextAngle, ", angleRad: ").concat(angleRad, ", nextAngleRad: ").concat(nextAngleRad));
          ctx.beginPath();
  ...
  var highlightWinner = function highlightWinner() {
    ...
    var _iterator = _createForOfIteratorHelper(losers),
      _step;
    try {
  ...
  var getTarget = function getTarget(forceTarget) {
    ...
    console.log("target item: ".concat(randomThings[targetThingIndex]));
    // console.log(`currentRotation: ${currentRotation}`);
    console.log("targetRotation: ".concat(targetRotation));
    var extraSpins = 3;
