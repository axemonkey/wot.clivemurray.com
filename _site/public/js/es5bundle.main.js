(function () {
  ...
  */
  ...
  var currentThings;
  var gamesThings = ['Munchkin', 'Escape the Dark Castle', 'Unearth', 'Gubs', 'Star Fluxx', 'Martian Fluxx', 'Doomlings', 'Dragonwood', 'Dragonrealm', 'Forbidden Island', 'Forbidden Desert', 'Forbidden Sky', 'Forbidden Jungle', 'Labyrinth', 'Boss Monster', 'Boss Monster: The Next Level', 'Selfish: Zombie Edition', 'Selfish: Space Edition', 'Bag of Dungeon'];
